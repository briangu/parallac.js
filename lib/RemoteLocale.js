...
var RemoteLocale = function (config, id) {
  ...
  socket.on('write', function (data) {
    // a console.log style formatted stdout.write
    // console.log("write", `${util.format.apply(null, JSON.parse(data.args))}`)
    process.stdout.write(`${util.format.apply(null, JSON.parse(data.args))}`)
  });
